          ...
          <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="max-w-lg text-balance leading-relaxed">
                ...
                quae voluptatem, commodi excepturi laboriosam officia atque
                dolorem quisquam praesentium dolor harum fugit quam non quo
                incidunt
              </CardDescription>
            </CardHeader>
            <CardFooter>
          ...
          <TabsContent value="week">
            <Card x-chunk="dashboard-05-chunk-3">
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Ordenes recientes en su tienda.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
        ...
        <Card className="overflow-hidden" x-chunk="dashboard-05-chunk-4">
          <CardHeader className="flex flex-row items-start bg-muted/50">
            <div className="grid gap-0.5">
              ...
              <CardDescription>Date: Noviembre 23, 2024</CardDescription>
            </div>
          ...
          <CardContent className="p-6 text-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-3">
                <div className="font-semibold">Información de envió</div>
          ...
          <CardFooter className="flex flex-row items-center border-t bg-muted/50 px-6 py-3">
            <div className="text-xs text-muted-foreground">
              Actualizado <time dateTime="2023-11-23">Noviembre 23, 2024</time>
            </div>
